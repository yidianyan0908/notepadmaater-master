...
public class NotesList extends ListActivity {
    ...
    private void sortNotes() {
        // 弹出对话框让用户选择排序方式
        CharSequence[] items = {"Sort by Title", "Sort by Date"};
    ...
    private void setInitialColorSelection(View dialogView) {
        LinearLayout dialogViewContainer = (LinearLayout) dialogView;
        View firstButton = dialogViewContainer.getChildAt(0);
        firstButton.setTag("selected");
        firstButton.setBackgroundColor(Color.GRAY); // Highlight the first button
    }
